-- Seed workflow template v2.3.0 into workflow_templates table
-- This version fixes:
...
VALUES (
  'prepare-miro-workshop-v2.3.0',
  'Prepare Miro Workshop Board v2.3.0',
  'AI-støttet workshop board med FIX for posisjonering: Sticky notes plasseres nå korrekt inne i frames med relative posisjoner.',
  'workshop',
  '/webhook/prepare-miro-workshop',
  ARRAY['miro'],
  ARRAY['miro_oauth'],
  '2.3.0',
  'v2.3.0: Fix - Relative posisjoner inne i frames, kun width i geometry (ikke height), fikset duplikat-trigger',
  '{
