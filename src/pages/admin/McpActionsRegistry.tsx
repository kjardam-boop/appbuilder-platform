...
export default function McpActionsRegistry() {
  ...
  return (
    <div className="container mx-auto py-8 space-y-6">
      ...
      <div className="space-y-2">
        <h1 className="text-3xl font-bold">MCP Actions Registry</h1>
        <p className="text-muted-foreground">
          Oversikt over registrerte MCP-aksjoner for {tenant?.name}
        </p>
      </div>
